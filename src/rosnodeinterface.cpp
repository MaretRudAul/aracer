...
// C/C++ source code generated on : Thu Nov 21 14:38:50 2024
//
...
#define ROS_SET_RTM_ERROR_STATUS(status) rtmSetErrorStatus(aracer_M,(status));
#define ROS_GET_RTM_ERROR_STATUS()     rtmGetErrorStatus(aracer_M)
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"aracer\" **\n");
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(ROS_GET_RTM_ERROR_STATUS()
                == (NULL)) || rtmGetStopRequested(aracer_M));
